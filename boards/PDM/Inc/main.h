...
#define _24V_BOOST_SENSE_Pin GPIO_PIN_0
#define _24V_BOOST_SENSE_GPIO_Port GPIOC
#define _24V_ACC_SENSE_Pin GPIO_PIN_1
#define _24V_ACC_SENSE_GPIO_Port GPIOC
#define IN_DI_FRONT_RHS_Pin GPIO_PIN_2
#define IN_DI_FRONT_RHS_GPIO_Port GPIOC
#define IN_DI_REAR_LHS_Pin GPIO_PIN_3
#define IN_DI_REAR_LHS_GPIO_Port GPIOC
